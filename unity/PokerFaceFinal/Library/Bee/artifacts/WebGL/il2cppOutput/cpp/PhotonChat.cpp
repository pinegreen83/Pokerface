...
IL_0080:
	{
		...
		InterfaceActionInvoker2< uint8_t, String_t* >::Invoke(0, IChatClientListener_t7809F4EE0368FF3496A7123CCAFF8BA0B1A02B2F_il2cpp_TypeInfo_var, L_12, 2, _stringLiteralCA95F4BEB64A322209E2124DA276E04A8779F727);
...
IL_0098:
	{
		...
		String_t* L_17 = __this->___ProxyServerAddress;
		bool L_18;
		L_18 = VirtualFuncInvoker5< bool, String_t*, String_t*, String_t*, RuntimeObject*, RuntimeObject* >::Invoke(7, L_15, L_16, L_17, _stringLiteral84F3409D006A485853CE590C6F1C4AA00ABCA26F, NULL, NULL);
		bool L_19 = L_18;
		if (!L_19)
		{
			G_B7_0 = L_19;
...
IL_00d1:
	{
		bool L_20;
		L_20 = ChatClient_get_UseBackgroundWorkerForSending_mB1BDA076DABA2774E60635B640BF176C062FF288_inline(__this, NULL);
		if (!L_20)
		{
			G_B9_0 = G_B7_0;
			goto IL_00f6;
...
IL_003d:
	{
		RuntimeObject* L_6 = __this->___listener;
		InterfaceActionInvoker2< uint8_t, String_t* >::Invoke(0, IChatClientListener_t7809F4EE0368FF3496A7123CCAFF8BA0B1A02B2F_il2cpp_TypeInfo_var, L_6, 2, _stringLiteralCA95F4BEB64A322209E2124DA276E04A8779F727);
		ChatClient_set_TransportProtocol_m21D6C23D1B7EE7C8C4C71C5D5FBCB4FDBB58DD23(__this, 5, NULL);
	}
...
IL_0055:
	{
		...
		String_t* L_9 = __this->___ProxyServerAddress;
		bool L_10;
		L_10 = VirtualFuncInvoker5< bool, String_t*, String_t*, String_t*, RuntimeObject*, RuntimeObject* >::Invoke(7, L_7, L_8, L_9, _stringLiteral73442709295E0907BAB5FF689567842B1B7D4C01, NULL, NULL);
		if (L_10)
		{
			goto IL_009c;
		}
